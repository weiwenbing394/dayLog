//
//  MyDragAndDropCollectionViewLayout.h
 ...
 */
@interface MyDragAndDropCollectionViewLayout : UICollectionViewLayout
 ...
 */
@property (nonatomic) CGFloat horizonSpace;
...
/**
 * Lets you know if the collection view is page by page
 */
@property (nonatomic, assign) BOOL isPageable;
